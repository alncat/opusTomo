...
def add_args(parser):
    ...
    group.add_argument('--downfrac', type=float, default=1.0, help='downsample to (default: %(default)s) of original size')
...
def train_batch(model, lattice, y, yt, rot, trans, optim, beta,
                ...
                snr2=1., body_poses=None, ctf_filename=None, rank=0, world_size=1):
        ...
        #for minibatch in data_generator:
            ...
            z_mu, loss, gen_loss, snr, l1_loss, tv_loss, mu2, std2, mmd, c_mmd, mse, body_poses_pred = \
                                        train_batch(model, lattice, y, yt, rot, tran, optim, beta,
                                              ...
                                              snr2=snr_ema, body_poses=(body_euler, body_trans), ctf_filename=ctf_filename, rank=rank, world_size=world_size)
            update_it += 1
