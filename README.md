...
Opus-TOMO mainly assumes the tomogram is reconstructed by Aretomo. Aretomo's output has the same convention as IMOD's though Aretomo goes through a series of transformations.
