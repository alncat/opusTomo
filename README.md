...
The ctf estimation can then be performed by ```ctfplotter -pa ctfplotter.com```.
...
all orientation information can be used to train OPUS-TOMO! The block below shows the columns in the combined starfile.
```
data_
